<script lang="ts">
	...
	const group: any = getContext('group');
	export let pill: boolean = false;
	export let outline: boolean = false;
	export let size: string = group ? 'sm' : 'md';
	export let href: string | undefined = undefined;
	export let type: 'button' | 'submit' | 'reset' | null | undefined = 'button';
	export let color: string = group ? (outline ? 'dark' : 'alternative') : 'primary';
	...
	const colorCheckedClasses: Record<string, string> = {
		alternative:
		...
		primary:
			'text-primary-600 bg-primary-100 dark:bg-primary-600 shadow-primary-400 dark:shadow-primary-500 shadow-inner',
		purple:
	...
	const coloredFocusClasses: Record<string, string> = {
		...
		primary: 'focus-within:ring-primary-100 dark:focus-within:ring-primary-500',
		purple: 'focus-within:ring-purple-300 dark:focus-within:ring-purple-900',
		red: 'focus-within:ring-red-300 dark:focus-within:ring-red-900',
		yellow: 'focus-within:ring-yellow-300 dark:focus-within:ring-yellow-900',
		none: ''
	};
	const coloredShadowClasses: Record<string, string> = {
		alternative: 'shadow-gray-500/50 dark:shadow-gray-800/80',
		blue: 'shadow-blue-500/50 dark:shadow-blue-800/80',
		dark: 'shadow-gray-500/50 dark:shadow-gray-800/80',
		green: 'shadow-green-500/50 dark:shadow-green-800/80',
		light: 'shadow-gray-500/50 dark:shadow-gray-800/80',
		primary: 'shadow-primary-600/50 dark:shadow-primary-700/80',
	...
	const outlineClasses: Record<string, string> = {
		...
		primary:
			'text-primary-400 hover:text-white border border-primary-400 hover:bg-primary-400 dark:border-primary-200 dark:text-primary-200 dark:hover:text-white dark:hover:bg-primary-300',
		purple:

...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Cpu.Core.CpuCoreDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Cpu.Core.CpuCoreMetricsDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Cpu.CpuDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Cpu.CpuMetricsDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Disk.DiskDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Disk.DiskMetricsDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Interface.InterfaceDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Interface.InterfaceMetricsDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Memory.MemoryDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Memory.MemoryMetricsDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Device.DeviceConnectionDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Device.DeviceDBO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Cpu.Core.CpuCoreDBO", b =>
                {
                    b.HasOne("Netmon.Data.DBO.Component.Cpu.CpuDBO", "Cpu")
                        .WithMany("CpuCores")
                        .HasForeignKey("CpuId")
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Cpu.Core.CpuCoreMetricsDBO", b =>
                {
                    b.HasOne("Netmon.Data.DBO.Component.Cpu.Core.CpuCoreDBO", "CpuCore")
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Cpu.CpuDBO", b =>
                {
                    b.HasOne("Netmon.Data.DBO.Device.DeviceDBO", "Device")
                        .WithMany("Cpus")
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Disk.DiskMetricsDBO", b =>
                {
                    b.HasOne("Netmon.Data.DBO.Component.Disk.DiskDBO", "Disk")
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Interface.InterfaceMetricsDBO", b =>
                {
                    b.HasOne("Netmon.Data.DBO.Component.Interface.InterfaceDBO", "Interface")
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Component.Memory.MemoryMetricsDBO", b =>
                {
                    b.HasOne("Netmon.Data.DBO.Component.Memory.MemoryDBO", "Memory")
            ...
            modelBuilder.Entity("Netmon.Data.DBO.Device.DeviceConnectionDBO", b =>
                {
                    b.HasOne("Netmon.Data.DBO.Device.DeviceDBO", "Device")
                        ...
                        .HasForeignKey("Netmon.Data.DBO.Device.DeviceConnectionDBO", "DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
